...
<?php include_once('header.php')?>
    ...
    <main  class="contents">
        ...
        <p>新規パスワード：<input type="password" maxlength='16' pattern="^[0-9A-Za-z]{8,16}$" name ="password" value="" placeholder="8桁以上16桁未満"  required><br/></p>
        <p>確認パスワード：<input type="password" maxlength='16' pattern="^[0-9A-Za-z]{8,16}$" name ="con_password" value="" placeholder="上記と同じパスワード"  required><br/></p>
